            ...
            return (
                <li key={loan.id} className="w-full flex justify-between gap-x-6 py-5">
                    <div className="flex min-w-1/2 gap-x-4">
                        <Image alt="" src="https://img.icons8.com/3d-fluency/94/cash-in-hand.png" width={100} height={100} className="h-12 w-12 flex-none" />
                    ...
                    <div className="shrink-0 sm:flex sm:flex-col sm:items-end">
                        <p className="text-sm/6 text-white">Due {loan.dateDue}</p>
